...
export const badRequest = (msg, errors = null) => new AppError(msg, 400, errors, { code: 'ERR_BAD_REQUEST' });
...
export const TooManyRequests = (msg = "Too many requests", d = null) => new AppError(msg, 429, d, { code: 'ERR_TOO_MANY_REQUESTS' });
